...
# created the special class that i am going to use from here on to predict new data
class absenteeism_model():
    ...
    # took a data file (*.csv) and preprocess it.
    def load_and_clean_data(self, data_file):
        ...
        # created a separate dataframe, containing dummy values for ALL avaiable reasons
        ...
        # created a list with month values retrieved from the 'Date' column
        list_months = []
